...
st.set_page_config(page_title="Multi-Agent Research Paper Assistant", layout="wide")

st.title("📚 Welcome! Multi-Agent Research Paper Assistant")
...
# Add footer with personal information
footer = """
<div style="position: fixed; bottom: 0; width: 100%; text-align: center; padding: 10px;">
    <p>&copy; 2025 Created with <span class="heart">&#9829;</span> by Santunu Sahoo | 
        <a href="https://www.linkedin.com/in/santanusahoo2003/" target="_blank">LinkedIn</a>
    </p>
</div>
"""
